...
export class ApiHelper {
  ...
  static readonly user = {
    ...
    getCreateUserRoles: 'get-create-user-roles'
  };
  ...
  static readonly patient = {
    ...
    getAllActivePatient: 'get-all-active-patients-except',
    getAllActiveDoctors: 'get-all-active-doctors',
    getUserById: '',
    add: 'create-patient',
    update: 'update',
  ...
  static readonly priceListItems = {
    ...
    getAllActivePriceListItemsByPharmacyId:
      'get-active-pricelist-item-by-pharmacyid',
  ...
  static readonly conversation = {
    ...
    create: 'create',
    getUnReadConversationByCounselorId:
      'get-unread-conversation-by-counselorId',
