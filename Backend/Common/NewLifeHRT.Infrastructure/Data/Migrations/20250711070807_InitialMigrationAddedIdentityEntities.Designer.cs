...
namespace NewLifeHRT.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250711070807_InitialMigrationAddedIdentityEntities")]
    partial class InitialMigrationAddedIdentityEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NewLifeHRT.Domain.Entities.Address", b =>
                {
                    b.HasOne("NewLifeHRT.Domain.Entities.ApplicationUser", "User")
                        .WithOne("Address")
                        .HasForeignKey("NewLifeHRT.Domain.Entities.Address", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
