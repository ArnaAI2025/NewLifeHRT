...
namespace NewLifeHRT.Application.Services.Mappings
{
    ...
    {
        public static CommissionsPayableResponse ToCommissionsPayableResponse(this CommissionsPayable entity)
        {
            var order = entity.Order;
            var patient = order?.Patient;
            var pharmacy = order?.Pharmacy;

            return new CommissionsPayableResponse
            {
        ...
        public static List<CommissionsPayableResponse> ToCommissionsPayableResponseList(this IEnumerable<CommissionsPayable> entities)
        {
            return entities?.Select(e => e.ToCommissionsPayableResponse()).ToList() ?? new List<CommissionsPayableResponse>();
        }
        public static CommissionsPayableDetailResponse? ToCommissionsPayableDetailResponse(this CommissionsPayable entity)
        {
            ...
            return new CommissionsPayableDetailResponse
            {
