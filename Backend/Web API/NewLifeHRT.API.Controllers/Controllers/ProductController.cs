...
namespace NewLifeHRT.API.Controllers.Controllers
{
    ...
    public class ProductController : BaseApiController<ProductController>
    {
        ...
        public ProductController(IProductService productService, IProductTypeService productTypeService, IProductCategoryService productCategoryService, IProductStatusService productStatusService, IProductWebFormService productWebFormService)
        {
