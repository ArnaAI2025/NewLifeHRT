...
namespace NewLifeHRT.API.Controllers.Controllers
{
    ...
    public class PriceListItemController : BaseApiController<PriceListItemController>
    {
        ...
        private readonly ILifeFileQuantityUnitService _lifeFileQuantityUnitsService;

        public PriceListItemController(IPriceListItemService priceListItemService, ILifeFileScheduleCodeService lifeFileScheduleCodeService, ILifeFileDrugFormService lifeFileDrugFormService, ILifeFileQuantityUnitService lifeFileQuantityUnitsService)
        {
