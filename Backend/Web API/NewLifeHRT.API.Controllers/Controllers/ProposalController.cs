...
namespace NewLifeHRT.API.Controllers.Controllers
{
    ...
    public class ProposalController : BaseApiController<ProposalController>
    {
        ...
        public async Task<IActionResult> AcceptProposal(Guid id)
        {
            ...
            var result = await _proposalService.UpdateProposalStatusAsync(id, (int)StatusEnum.Approved, null, userId.Value);
        ...
        public async Task<IActionResult> AcceptByPatientProposal(Guid id)
        {
            ...
            var result = await _proposalService.UpdateProposalStatusAsync(id, (int)StatusEnum.ApprovedByPatient, null, userId.Value);
        ...
        public async Task<IActionResult> RejectProposal(Guid id, [FromBody] string? description)
        {
            ...
            var result = await _proposalService.UpdateProposalStatusAsync(id, (int)StatusEnum.Rejected, description, userId.Value);
        ...
        public async Task<IActionResult> RejectByPatientProposal(Guid id, [FromBody] string? description)
        {
            ...
            var result = await _proposalService.UpdateProposalStatusToRejectByPatientAsync(id, (int)StatusEnum.RejectedByPatient, description, userId.Value);
        ...
        public async Task<IActionResult> CancelProposal(Guid id)
        {
            ...
            var result = await _proposalService.UpdateProposalStatusAsync(id, (int)StatusEnum.Canceled, null, userId.Value);
