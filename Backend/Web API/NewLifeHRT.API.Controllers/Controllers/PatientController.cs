...
namespace NewLifeHRT.API.Controllers.Controllers
{
    ...
    public class PatientController : BaseApiController<PatientController>
    {
        ...
        public PatientController(IPatientService patientService, IVisitTypeService visitTypeService, IAgendaService agendaService, IDocumentCategoryService documentCategoryService, IPatientCreditCardService patientCreditCardService)
        {
