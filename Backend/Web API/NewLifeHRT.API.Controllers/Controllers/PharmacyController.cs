...
namespace NewLifeHRT.API.Controllers.Controllers
{
    ...
    public class PharmacyController : BaseApiController<PharmacyController>
    {
        ...
        {
            var shippingMethods = await _shippingMethodService.GetAllActiveAsync();
        ...
        {
            var pharmacyShippingMethods = await _pharmacyShippingMethodService.GetAllPharmacyShippingMethod(id);
            return Ok(pharmacyShippingMethods);
        }
